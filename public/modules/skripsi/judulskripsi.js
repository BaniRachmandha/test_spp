var subapp = {
    ...
    form: {
        ...
        fillform: function(id, dt) {
            ...
            $('input#prodi').val(dt.prodi);
            $('textarea#jdlskripsi').val(dt.jdlskripsi);            
    ...
    upload: function() {
        var d = new FormData();
        d.append('filenya', $('#formpage #fileskripsi')[0].files[0]);
    ...
    rendertable: function() {
        ...
        subapp.table = $("#tabelutama").DataTable({
            ...
            columns: [
                ...
                { data: 'prodi', className: 'text-left' },                
                { data: 'jdlskripsi', className: 'text-left' },
    ...
    data: {
        ...
        form: function() {
            ...
            out.prodi = $('#fmutama input#prodi').val();
            out.jdlskripsi = $('#fmutama textarea#jdlskripsi').val();
    ...
    save: function() {
        ...
        app.notif.confirm('Konfirmasi', app.confirm.save('data judul Skrpisi/TA'), function() {
            app.ajax({
                type: 'post',
                dataType: 'json',
