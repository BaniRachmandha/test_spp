var subapp = {
    ...
    form: {
        ...
        fillform: function(id, dt) {
            ...
            $('input#jdlinfo').val(dt.jdl_info);
            $('textarea#deskinfo').val(dt.deskinfo);
            $('input#datecreate').val(dt.cd);
            $('input#idfile').val(dt.id_files);
            $('textarea#ketinfo').val(dt.ketinfo);
    ...
    upload: function() {
        var d = new FormData();
        d.append('filenya', $('#formpage #fileakademik')[0].files[0]);
    ...
    rendertable: function() {
        ...
        subapp.table = $("#tabelutama").DataTable({
            ...
            columns: [
                { data: 'id' },
                { data: 'jdl_info', className: 'text-left' },
                { data: 'deskinfo', className: 'text-left' },
                { data: 'datecreate', className: 'text-left' },
                { data: 'ketinfo', className: 'text-left' },
    ...
    data: {
        ...
        form: function() {
            ...
            out.jdlinfo = $('#fmutama input#jdlinfo').val();
            out.deskinfo = $('#fmutama textarea#deskinfo').val();
            out.datecreate = $('#fmutama input#datecreate').val();
            out.idfile = $('#fmutama input#idfile').val();
            out.ketinfo = $('#fmutama textarea#ketinfo').val();
            return out;
        },
        remove: function(id) {
            var out = {};
    ...
    save: function() {
        ...
        app.notif.confirm('Konfirmasi', app.confirm.save('data info akademik'), function() {
            app.ajax({
                type: 'post',
                dataType: 'json',
