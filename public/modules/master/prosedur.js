var subapp = {
    ...
    form: {
        ...
        fillform: function(id, dt) {
            ...
            $('input#jdlprosedur').val(dt.jdl_prosedur);
            $('textarea#deskprosedur').val(dt.deskprosedur);
            $('input#datecreate').val(dt.cd);
            $('input#idfile').val(dt.id_files);
            $('input#jnsfile').val(dt.jnsfile);
            $('textarea#ketprosedur').val(dt.ketprosedur);
    ...
    upload: function() {
        var d = new FormData();
        d.append('filenya', $('#formpage #fileprosedur')[0].files[0]);
    ...
    rendertable: function() {
        ...
        subapp.table = $("#tabelutama").DataTable({
            ...
            columns: [
                { data: 'id' },
                { data: 'jdl_prosedur', className: 'text-left' },
                { data: 'deskprosedur', className: 'text-left' },
                { data: 'datecreate', className: 'text-left' },
                { data: 'jnsfile', className: 'text-left' },
                { data: 'ketprosedur', className: 'text-left' },
    ...
    data: {
        ...
        form: function() {
            ...
            out.jdlprosedur = $('#fmutama input#jdlprosedur').val();
            out.deskprosedur = $('#fmutama textarea#deskprosedur').val();
            out.datecreate = $('#fmutama input#datecreate').val();
            out.idfile = $('#fmutama input#idfile').val();
            out.jnsfile = $('#fmutama input#jnsfile').val();
            out.ketprosedur = $('#fmutama textarea#ketprosedur').val();
            return out;
        },
        remove: function(id) {
            var out = {};
    ...
    save: function() {
        ...
        app.notif.confirm('Konfirmasi', app.confirm.save('data prosedur & pedoman'), function() {
            app.ajax({
                type: 'post',
                dataType: 'json',
